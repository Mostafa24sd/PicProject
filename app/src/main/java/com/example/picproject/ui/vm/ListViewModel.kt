...
class ListViewModel @Inject constructor(
    ...
    val photos = Transformations.switchMap(combinedValues) {
        ...
        if (!query.isNullOrEmpty() && !sortBy.isNullOrEmpty()) {
            ...
            repository.getListResults(query, DEFAULT_LIST_TYPE, sortBy).cachedIn(viewModelScope)
        } else null
    }


    fun refresh(query: String, sortBy: SortBy) {
    ...
    companion object {
        ...
        private val DEFAULT_QUERY = DEFAULT_LIST_KEY
